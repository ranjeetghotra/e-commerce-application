...
export class WishlistPage {
    ...
    ionViewDidEnter() {
        ...
        this.storage.get('USER_KEY').then(function (val) {
            ...
            loading.present();
            _this.http.get('http://swasthyashoppe.com/api/wishlist.php?action=list&uid=' + val).subscribe(function (data) {
                console.log(data);
    ...
    removeit(pid) {
        ...
        this.storage.get('USER_KEY').then(function (val) {
            ...
            loading.present();
            _this.http.get('http://swasthyashoppe.com/api/removeFromWish.php?product_id=' + pid + '&uid=' + val).subscribe(function (data) {
                console.log(data);
